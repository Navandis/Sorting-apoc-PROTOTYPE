...
func _build_floor_and_ceiling_plan() -> void:
	...
	_floor_zone("SharedABJunction", "SharedABJunction", 4.5, 9.0, -13.0, -1.5, CLEAR_HEIGHT, "floor_storage")
	_district("SharedABJunction").set_meta("diagnostic_classification", "Main Storage circulation")
	_district("SharedABJunction").set_meta("measurement_group", "MainStorage")
	...
	_floor_zone("Salvager", "SalvagerPocket", 2.0, 8.0, 23.5, 28.5, CLEAR_HEIGHT, "floor_service")
	...
	_floor_zone("Incinerator", "IncineratorApproach", 34.5, 38.5, 4.5, 10.0, CLEAR_HEIGHT, "floor_service")
	_floor_zone("Incinerator", "IncineratorPocket", 33.0, 40.0, 10.0, 17.0, CLEAR_HEIGHT, "floor_service")
...
func _build_structural_walls() -> void:
	...
	_wall_x_joined(backlog, "BacklogSouth", -28.5, -15.0, 3.8, CLEAR_HEIGHT, false, true)
	_wall_z(backlog, "BacklogEastNorth", -15.0, -3.8, -3.4)
	_wall_z(backlog, "BacklogEastSouth", -15.0, 1.44, 3.8)

	var sorting := _district("Sorting")
	_wall_x_joined(sorting, "SortingNorthWestShoulder", -15.0, -14.0, -5.0)
	...
	_wall_x_joined(sorting, "SortingNorthEastShoulder", -6.0, -5.0, -5.0)
	_wall_x_joined(sorting, "SortingSouthWest", -15.0, -12.0, 5.0)
	_wall_x_joined(sorting, "SortingSouthEast", -8.0, -5.0, 5.0)
	...
	_wall_x_joined(spine, "SpineWestNorthB", 3.0, 4.5, -1.5, CLEAR_HEIGHT, false, true)
	_wall_x_joined(spine, "SpineWestSouthA", -5.0, 0.0, 5.5, CLEAR_HEIGHT, true, false)
	...
	_wall_x_joined(spine, "SpineEastNorthBWest", 9.0, 11.0, -1.5, CLEAR_HEIGHT, true, false)
	_wall_x_joined(spine, "SpineEastNorthBEast", 14.0, 26.0, -1.5, CLEAR_HEIGHT, false, true)
	_wall_x_joined(spine, "SpineEastSouthWest", 4.5, 9.0, 7.0, CLEAR_HEIGHT, true, false)
	_wall_x(spine, "SpineEastSouthMid", 12.0, 20.0, 7.0)
	_wall_x_joined(spine, "SpineEastSouthEast", 23.0, 26.0, 7.0, CLEAR_HEIGHT, false, true)
	...
	_wall_x_joined(gallery_a, "GalleryANorthWestShoulder", -5.0, -3.0, -13.0, CLEAR_HEIGHT, false, true)
	...
	_wall_x_joined(junction, "SharedJunctionNorthWest", 4.5, 5.8, -13.0, CLEAR_HEIGHT, false, true)
	...
	_wall_x_joined(kitchen, "KitchenEastLegSouth", 16.5, 26.4, -5.4, CLEAR_HEIGHT, true, false)
	_wall_z_joined(kitchen, "KitchenNorthLegWest", 23.6, -18.0, -8.2)
	_wall_z_joined(kitchen, "KitchenNorthLegEast", 26.4, -18.0, -5.4)
	_wall_x(kitchen, "KitchenRoomSouthWest", 21.4, 23.6, -18.0)
	_wall_x(kitchen, "KitchenRoomSouthEast", 26.4, 31.9, -18.0)
	_wall_z_joined(kitchen, "KitchenRoomWest", 21.4, -25.0, -18.0)
	_wall_z_joined(kitchen, "KitchenRoomEast", 31.9, -25.0, -18.0)

	var gallery_c := _district("GalleryC")
	_wall_z(gallery_c, "GalleryCWest", -2.0, 5.5, 15.0)
	_wall_x_joined(gallery_c, "GalleryCNorthEastReturn", 4.5, 6.0, 5.5, CLEAR_HEIGHT, false, true)
	_wall_x_joined(gallery_c, "GalleryCSouthWest", -2.0, 2.0, 15.0)
	_wall_z(gallery_c, "GalleryCDividerNorth", 6.0, 5.5, 9.0)
	_wall_z(gallery_c, "GalleryCInsetWest", 2.0, 11.5, 15.0)
	_wall_x_joined(gallery_c, "GalleryCInsetCap", 2.0, 6.0, 11.5)

	var gallery_d := _district("GalleryD")
	_wall_z(gallery_d, "GalleryDWestSouthReturn", 6.0, 11.5, 17.5)
	_wall_z_joined(gallery_d, "GalleryDEast", 15.5, 7.0, 17.5)
	_wall_x_joined(gallery_d, "GalleryDSouthWest", 6.0, 9.5, 17.5, CLEAR_HEIGHT, true, false)
	...
	_wall_x_joined(workshop, "WorkshopRoomNorthEast", -8.0, -6.0, 15.0)
	...
	_wall_x_joined(salvager, "SalvagerCrossNorth", -6.0, 8.0, 20.0, CLEAR_HEIGHT, true, false)
	_wall_x_joined(salvager, "SalvagerCrossSouth", -6.0, 2.0, 24.0)
	_wall_z_joined(salvager, "SalvagerPocketWest", 2.0, 24.0, 28.5)
	_wall_z_joined(salvager, "SalvagerEast", 8.0, 20.0, 28.5)
	_wall_x_joined(salvager, "SalvagerBack", 2.0, 8.0, 28.5)

	var deeper := _district("DeeperApproach")
	_wall_x(deeper, "DeeperWideNorth", 26.0, 39.0, 0.0)
	_wall_x_joined(deeper, "DeeperWideSouthWest", 26.0, 34.5, 4.5, CLEAR_HEIGHT, false, true)
	_wall_x_joined(deeper, "DeeperWideSouthEast", 38.5, 43.0, 4.5, CLEAR_HEIGHT, true, false)
	...
	_wall_x_joined(deeper, "DeeperNarrowNorth", 43.0, 59.0, -7.0, CLEAR_HEIGHT, false, true)
	_wall_x_joined(deeper, "DeeperNarrowSouth", 43.0, 59.0, -4.0, CLEAR_HEIGHT, false, true)

	var incinerator := _district("Incinerator")
	_wall_z(incinerator, "IncineratorApproachWest", 34.5, 4.5, 10.0)
	_wall_z(incinerator, "IncineratorApproachEast", 38.5, 4.5, 10.0)
	_wall_x_joined(incinerator, "IncineratorPocketNorthWest", 33.0, 34.5, 10.0)
	_wall_x_joined(incinerator, "IncineratorPocketNorthEast", 38.5, 40.0, 10.0)
	_wall_z(incinerator, "IncineratorPocketWest", 33.0, 10.0, 17.0)
	_wall_z(incinerator, "IncineratorPocketEast", 40.0, 10.0, 17.0)
	_wall_x_joined(incinerator, "IncineratorPocketBack", 33.0, 40.0, 17.0)
...
func _build_spatial_proxies() -> void:
	...
	_box(_proxies, "IncineratorMachine", Vector3(36.5, 1.45, 14.75), Vector3(6.2, 2.9, 3.5), _materials["machine"])
...
func _build_anchors() -> void:
	...
	_anchor("IncineratorFront", Vector3(36.5, 0.05, 12.4), 180.0)
