...
Status: **WAVE 1 IMPLEMENTED / TECHNICALLY VERIFIED / HUMAN CALIBRATION PENDING**
...
All calibration values and socket positions below are **UNPROMOTED / HUMAN CALIBRATION PENDING**. They are useful starting points for the retained review tool, not production geometry authority. No Wave-2 code may depend on them until a human reviews and explicitly promotes them.
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| `crate_plastic_01` | `res://assets/environment/dressing/containers/SM_PlasticBox_01.glb` | Crate | Success | 0.4704 × 0.1280 × 0.5824 | 5 × 6 | (0, 0, 0) | (0, 0.028, 0) | 0.39 × 0.50 | 0.65 | Mesh bounds seed the base only. Confirm the support plane is on the actual interior bottom and the inset avoids walls. |
| `crate_plastic_06` | `res://assets/environment/dressing/containers/SM_PlasticBox_06.glb` | Crate | Success | 0.4500 × 0.1249 × 0.6400 | 5 × 7 | (0, 0, 0) | (0, 0.028, 0) | 0.37 × 0.55 | 0.65 | Confirm interior bottom height and long-axis inset. |
| `crate_palletcart_box` | `res://assets/environment/dressing/containers/SM_PalletCart_box.glb` | Crate | Success | 0.3509 × 0.1312 × 0.6174 | 4 × 7 | (0, 0.000154, 0) | (0, 0.030, 0) | 0.27 × 0.52 | 0.65 | Narrowest candidate; verify 2×2 readability and wall clearance carefully. |
| `crate_wood_01` | `res://assets/environment/dressing/containers/SM_Wooden_Crates_01.glb` | Crate | Success | 0.4013 × 0.1327 × 0.5576 | 5 × 6 | (0, 0.002239, 0) | (0, 0.032, 0) | 0.32 × 0.47 | 0.65 | Confirm uneven wood geometry does not intrude into the usable rectangle. |
| `crate_wood_02` | `res://assets/environment/dressing/containers/SM_Wooden_Crates_02.glb` | Crate | Success | 0.4129 × 0.1257 × 0.5900 | 5 × 6 | (0, 0.000330, 0) | (0, 0.030, 0) | 0.33 × 0.50 | 0.65 | Confirm actual interior floor and safe inset. |
| `pallet_01` | `res://assets/environment/dressing/containers/SM_Pallet01.glb` | Pallet | Success | 0.9635 × 0.1200 × 1.2814 | 10 × 13 | (0, 0, 0) | (0, 0.120, 0) | 0.88 × 1.18 | 1.20 | Support plane uses measured top as a starting point; confirm deck boards, not protruding feet/edges, govern cargo support. |
| `pallet_wood_03` | `res://assets/environment/dressing/containers/SM_WoodPallet_03.glb` | Pallet | Success | 0.8627 × 0.1558 × 1.2941 | 9 × 13 | (0, 0.000001, 0) | (0, 0.155829, 0) | 0.78 × 1.18 | 1.20 | Confirm the safe cargo deck inset and top height across the board pattern. |
| `pallet_industrial_worn_07` | `res://assets/environment/dressing/containers/SM_Ind_War_Storage_Pallet_Wood_Worn_07.glb` | Pallet | Success | 0.7618 × 0.1340 × 1.0521 | 8 × 11 | (0, 0.012479, 0) | (0, 0.133952, 0) | 0.68 × 0.96 | 1.20 | Visual lift seats the measured minimum Y at zero. Confirm deck top and usable inset against worn/protruding geometry. |
...
8. Edit fixture `.tres` values and/or socket values directly in the Inspector. Those human edits are authoritative developer authoring and must be preserved.

Review must determine, for every fixture: base footprint, visual transform, support-plane transform, usable width/depth, and stack clearance. Record the disposition as **PROMOTE** or **REVISE**. Do not begin Wave 2 until the calibration values and socket layout are explicitly approved.
