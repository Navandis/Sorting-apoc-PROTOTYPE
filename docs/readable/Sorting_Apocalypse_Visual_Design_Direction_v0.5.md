# Sorting Apocalypse Visual Design Direction v0.5
...
![Embedded table image 1](media/Sorting_Apocalypse_Visual_Design_Direction_v0.5_image_01.png)

![Embedded table image 2](media/Sorting_Apocalypse_Visual_Design_Direction_v0.5_image_02.png)
...
Design basis: GDD v0.8; Prototype Findings v0.8; Receiving/Elevator design; accepted whole-wing greybox and Medical tuning; seeded-storage prerequisite and current abandoned-route deferral.
...
Version 0.5 retains the established world, material and service-space grammar and records the neutral whole-wing greybox as human-PROMOTED. Three correction rounds and final Medical tuning resolved the outstanding spatial work. The accepted builder, saved scene and final overview now supply the working dimensional reference. Production art, furnished usability and game balance remain separate. [W17, H17, A17]
...
- Shelf height: Must preserve reliable top-level visibility without jumping or ladders. Ceiling irregularities, flush beams, and low structural elements can credibly justify moderate shelf heights.
...
![Embedded source image 3](media/Sorting_Apocalypse_Visual_Design_Direction_v0.5_image_03.png)
...
![Embedded source image 4](media/Sorting_Apocalypse_Visual_Design_Direction_v0.5_image_04.png)
...
![Embedded source image 5](media/Sorting_Apocalypse_Visual_Design_Direction_v0.5_image_05.png)
