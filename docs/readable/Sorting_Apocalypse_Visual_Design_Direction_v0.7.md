# Sorting Apocalypse Visual Design Direction v0.7
...
![Embedded document image 1](media/Sorting_Apocalypse_Visual_Design_Direction_v0.7_image_01.png)

![Embedded document image 2](media/Sorting_Apocalypse_Visual_Design_Direction_v0.7_image_02.png)
...
Version 0.7 | 21 September 2026

Design basis: GDD v0.10; Prototype Findings v0.10; accepted in-engine wing geometry; promoted storage authoring, orientation/zoning and canonical item pose; bounded fixed-ladder proof target.
...
Version 0.7 retains the accepted world, material, whole-wing and service-space direction. It promotes review-scene supply reuse, reusable functional ModularRack authoring, unit-owned semantic Front, canonical item-facing and the completed eligible-catalogue pose/Footprint pass. Production art, final gallery furnishing, camera and ceiling promotion, ladder implementation and Receiving remain separate work.
...
The bunker should become visually richer because the player fills, labels, upgrades and operates it, not because environment art competes for attention. Storage installations now have a reusable authoring grammar, per-instance semantic Front and consistent canonical item-facing. The active visual/interaction gate is one fixed ladder serving a selected taller rack. The core fantasy remains an experienced Quartermaster bringing order to a safe but resource-constrained underground community.
...
![Embedded document image 3](media/Sorting_Apocalypse_Visual_Design_Direction_v0.7_image_03.png)
...
![Embedded document image 4](media/Sorting_Apocalypse_Visual_Design_Direction_v0.7_image_04.png)
...
![Embedded document image 5](media/Sorting_Apocalypse_Visual_Design_Direction_v0.7_image_05.png)
...
The proof targets frontal attach, vertical W/S movement, held height, mouse-look inspection, safe top/bottom release behavior and retained storage interaction. It does not add animation, visible hands, general mantling, jumping, sliding/falling systems, shelf-top traversal or a sprint mode. The ladder also does not solve deep-shelf visibility, braces/rungs in the sightline, rear reach or every low/high shelf problem.

Exact yaw clamp, climb speed, installation geometry and human acceptability remain Validate/provisional.

### 33.6 Current validation order

1. Single-rack fixed-ladder proof.

1. Human ladder decision.

1. Receiving unless a concrete storage blocker appears.

Review-scene supply reuse, reusable functional ModularRack authoring, Storage Unit Orientation & Zoning Basis and Canonical Item Storage Pose & Shelf-Front Alignment are promoted foundations, not pending work.
